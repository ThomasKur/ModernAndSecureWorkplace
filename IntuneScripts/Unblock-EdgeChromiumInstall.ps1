<#
.Synopsis
This script will unblock the installation of the chromium based Microsoft Edge Browser.
...
$ScriptVersion = "001"
$ScriptName = "Unblock-EdgeChromiumInstall.ps1"
...
Set-RegValue -Path "HKLM:\SOFTWARE\Microsoft\EdgeUpdate" -Name DoNotUpdateToEdgeWithChromium -Value 0 -Type DWord
