...
function Start-ChildProcessing {
    ...
    #region Check if Process was Succesfull
        If($CurrentTaskOnlyWhenSuccessful -eq 1){
            ...
            $WriteToUserRegistry = $true
            Show-ToastMessage -Titel "Executing Active User Setup" -Message $ToastMessage -ProgressStatus "Runing"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUj7sdmFi8t7qAB7SPl5AZTzEe
# kCmgghsdMIIGajCCBVKgAwIBAgIQAwGaAjr/WLFr1tXq5hfwZjANBgkqhkiG9w0B
...
# hkiG9w0BCQQxFgQUyJ8q5Quta3wpODDi7xe3UT909WkwDQYJKoZIhvcNAQEBBQAE
# ggIANW1GsUV7bL+kyQBpPn6UdQj0x29/v9424Z15Fda9wJuCW/0KSmSrmSsVevKl
# F7Xa67T7dCnIbDc+wHOSqvO8Y6/ckcCcTSXYU3RoJfQlqxowMAvZZrBpIATo2drC
# w1hRS7MFJamJLVrud/12LZseTJrGMbc8QaxD7gRQtSCQd8uAX3moqgTFus6UM2Qn
# KWRFeV6rxKSxiKel59JYFy/vJjShIQoripROSyyaIScqjUQuKGDhNf7ZJPPuiUqg
# 9jPejiftFakWIQ2l/ahTUcyPPhIGq8O6K2zSVjbf/beY27NaD4hHhj6waGfZq9Pm
# ST9wioc1Vvb4Kb5isNmiXvCh76lKEmquHWdvJzEvJ9zMO+zXavVgsxIv9VV0KoKB
# +j2qrQEBEZwRa+t3MO/1GxxhhwLeCLhzPff+XkTIKDXBJwFborG1DEY/ey3cAfGr
# 7fPDeEdf+PEG8HMYKBwBetCt9lTODb44mjnstBl5Ei5OST58OqoeqnXZbHmLxMwj
# eKNHzF6oVaP0T/5faKpUQNyviSFqO+2PqMusT+qx79EDG5xSVuHaWiGlHPx1EtsW
# XWFzvJCIE98OEs/3NrDZeBlGmhruadMacG39kPoopBn+nKpzCvByRUh8sslMLI4Q
# 32y0TyvJ78fcaIo/EVxehRORphAHFGIuqgOj8zDS1DFw1lChggIPMIICCwYJKoZI
...
# DTE4MDkwOTE4MTU1M1owIwYJKoZIhvcNAQkEMRYEFMfcikyjJvdutaDc8O645kOs
# IWhUMA0GCSqGSIb3DQEBAQUABIIBAEhmFbxK++xJjgnq7Ug8ZDGZBc3yFpmXCJXV
# soJawrH77Th5/0RY0LQJ4qV+yECcVQKvH1DC+PEQAip+vxjtBbUwGa/sn7Sr9RYi
# bgVZ8ZupG/QHPB7R0QLeiF5h/hqFJA00x9tC8ZzWj+DwvTQbK4D4SNbHBlMsBSs3
# yn0nnUC//EDkuEKi83cMS2AfaiUvAdli5ZMiQKEmcox+DnKTsZvF9M6pETeGcHYf
# kUiwC42gfvz8f77x3WIQhjLmVMU8TxiFRk+y5bFgEVFpR3PDVFVsVsGgPkP7Wag4
# Cr++0hggMAcJ/wN8J8jW+chOyg/E0XF9M+C2/sla/JygUVKlQt4=
